...
<p><em>haughty</em>. C. <span class="ch">調貢高</span>, G. <em>udhida</em>, P. <em>uddhata</em>, S. <em>uddhata</em>. This term occurs in five MĀ <em>sūtra</em>s (15, 16, 91, 95, and 96), making it unlikely to be a typo. There is an alternate reading that changes <span class="ch">調</span> to <span class="ch">掉</span>, which is a case of amending an older translation with a later one. <span class="ch">掉</span> has the meaning of “shaking, swinging, rocking,” which probably was intended to describe physical restlessness.</p>
