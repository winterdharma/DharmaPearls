...
1. {:#n1} While this sutra doesn’t have a direct parallel in Pali or other sources, it’s essentially an abbreviated version of the Dasuttara Sutta, including the first four and last set of items found in DA 10 and [DN 34](https://suttacentral.net/dn34). [\[back\]](#ref1)
