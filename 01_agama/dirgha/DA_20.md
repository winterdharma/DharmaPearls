...
11. {:#n11}*Ulkāmukha … Hastikaśīrṣa … Karakaṇḍa … Opura*. C. 面光, 象食, 路指, 莊嚴; P. Okkāmukha, Karakaṇḍa, Hatthinika, and Sinisūra; S. Ulkāmukha, Hastikasirsa, Opura, Karakaṇḍa. The Chinese names in the list appear to include Ulkāmukha (面光) and Hastikasirsa (象食), but the other two are obscure. I’ve adopted the S. names. [\[back\]](#ref11)
...
*[Suyiva]*. C. 首夷婆 (MCh. ʃɪəu-yii-bua = \*Ṣuyiva). 翻梵語 (T2130.985c6) has an entry with this transliteration in a compound. It glosses it to mean “pure speech,” but I haven't ascertained an Indic equivalent that matches it's syllables.\\
