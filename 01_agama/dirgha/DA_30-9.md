...
1. {:#n1} This story is parallel to the Seven Suns Sutra (cf. [AN 7.66](https://suttacentral.net/an7.66){: target="_blank"} and [MĀ 8](../madhyama/MA_008.html){: target="_blank"}). [\[back\]](#ref1)
2. {:#n2} Mount Sudarśana has been omitted from this section, probably an accidental copyist error given that the sizes of the mountains don’t match those found in Chapter 1 from this point until it’s corrected for Mount Cakravāḍa. [\[back\]](#ref2)
