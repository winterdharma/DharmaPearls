...
1. {:#n1} This <em>sūtra</em> is a parallel to <a href="https://suttacentral.net/sn22.96/en/sujato" target="_blank">SN 22.96</a> and MĀ 61. The latter is interesting in that it represents a different version from another Savāstivāda canon that placed it in the <em>Madhyama Āgama</em>. This is likely direct evidence of a tradition moving <em>sūtra</em>s from one collection to another.<br/>
